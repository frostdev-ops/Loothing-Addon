...
L["SLASH_DESC_MLDB"] = "Refresh and broadcast Master Looter settings"
...
L["SLASH_DESC_SIM"] = "Boss-kill simulator (full pipeline)"
L["SLASH_DESC_HELP"] = "Show command help"
L["SLASH_DESC_START"] = "Activate loot handling"
L["SLASH_DESC_STOP"] = "Deactivate loot handling"
L["SLASH_DESC_VOTE"] = "Toggle the council voting table"
L["SLASH_DESC_REOPEN"] = "Reopen a closed voting window (response, council, award)"
L["SLASH_DESC_RESYNC"] = "Discard local session and resync from Master Looter"
L["ALLOW_RESPONSE_CHANGE"] = "Allow Response Changes"
L["ALLOW_RESPONSE_CHANGE_DESC"] = "Allow players to change their loot response after submitting. The original roll is preserved."
L["REOPEN_RESPONSE_FRAME"] = "Responses"
L["REOPEN_RESPONSE_FRAME_DESC"] = "Open the loot response frame to view or change your responses."
L["RESPONSE_CHANGE_NOT_ALLOWED"] = "The Master Looter has not enabled response changes."
L["COUNCIL_TABLE_HIDDEN_HINT"] = "Council table hidden. Type /lt reopen council to reopen."
L["MINIMAP_ACTIVE_SESSION"] = "Active Session"
L["MINIMAP_REOPEN_COUNCIL"] = "Reopen Council Table"
L["MINIMAP_REOPEN_RESPONSE"] = "Reopen Response Frame"
L["MINIMAP_REOPEN_AWARD"] = "Reopen Award Panel"
L["SHOW_COUNCIL_TABLE"] = "Council"
L["SHOW_COUNCIL_TABLE_DESC"] = "Open the council voting table to see candidates and cast votes."
L["RESYNC_NO_SESSION"] = "No active session to resync."
L["RESYNC_NO_ML"] = "Cannot resync: no Master Looter found."
L["RESYNC_IS_ML"] = "Cannot resync: you are the Master Looter."
L["RESYNC_STARTED"] = "Discarded local session. Requesting full resync from %s..."
L["RESYNC_NO_SYNC"] = "Sync module not available."
...
L["MLDB_REFRESH_NOT_GROUPED"] = "Must be in a group to broadcast MLDB settings."
L["MLDB_REFRESH_UNAVAILABLE"] = "MLDB module not available."
L["MLDB_REFRESH_NOT_ML"] = "Only the current Master Looter can refresh and broadcast MLDB settings."
L["MLDB_REFRESH_FAILED"] = "Failed to refresh MLDB settings."
L["MLDB_REFRESH_RESTORED"] = "Restored your local settings before broadcasting."
L["MLDB_REFRESH_SENT"] = "Broadcast your MLDB settings to the group."
L["ML_ASSIGNED_OUTSIDE_RAID_WARNING"] = "Warning: ML assigned outside a raid instance (raids-only setting is active)."
L["ML_LEFT_GROUP"] = "Master Looter %s has left the group. Use /lt ml to assign a new ML, or the new raid leader can start a session."
...
L["ML_HANDOVER_PROMPT_TEXT"] = "%s passed Master Looter to you.\n\nContinue with their session and settings, or discard them and start fresh with your own?"
L["ML_HANDOVER_PROMPT_TEXT_DETAIL"] = "%s passed Master Looter to you.\n\nInherited: %s\n\nContinue with their session and settings, or discard them and start fresh with your own?"
L["ML_HANDOVER_CONTINUE"] = "Continue"
L["ML_HANDOVER_START_FRESH"] = "Start Fresh"
L["ML_HANDOVER_CONTINUED"] = "Continuing %s's loot session as Master Looter."
L["ML_HANDOVER_FRESH"] = "Started a fresh Loothing session as the new Master Looter."
L["ML_HANDOVER_INHERITED_COUNCIL"] = "council (%d)"
L["ML_HANDOVER_INHERITED_MLDB"] = "MLDB"
L["ML_HANDOVER_INHERITED_ITEMS"] = "%d item(s) in flight"
...
-- Loot Filtering (configurable replacement for the old hardcoded blacklist)
L["LOOT_FILTER_HEADER"] = "Loot Filtering"
L["LOOT_FILTER_MIN_QUALITY"] = "Minimum Quality (auto mode)"
L["LOOT_FILTER_MIN_QUALITY_DESC"] = "Auto-mode minimum quality. Set to Poor to disable quality filtering. Prompt mode ignores this — every item reaches the Loot Picker so you can decide per-kill."
L["LOOT_FILTER_CLASS_HEADER"] = "Block Item Classes (auto mode)"
L["LOOT_FILTER_CLASS_DESC"] = "Item classes that auto mode silently drops. Prompt mode shows everything in the Loot Picker — these settings only affect what's checked by default there."
L["LOOT_FILTER_BLOCK_CONSUMABLES"] = "Block Consumables"
L["LOOT_FILTER_BLOCK_CONSUMABLES_DESC"] = "Potions, food, flasks, scrolls, etc."
L["LOOT_FILTER_BLOCK_REAGENTS"] = "Block Reagents"
L["LOOT_FILTER_BLOCK_REAGENTS_DESC"] = "Spell reagents (item class 5)."
L["LOOT_FILTER_BLOCK_TRADESKILL"] = "Block Recipes / Tradeskill items"
L["LOOT_FILTER_BLOCK_TRADESKILL_DESC"] = "Recipes, patterns, plans, schematics (item class 7)."
L["LOOT_FILTER_BLOCK_QUEST"] = "Block Quest items"
L["LOOT_FILTER_BLOCK_QUEST_DESC"] = "Quest objective drops (item class 12)."
L["LOOT_FILTER_BLOCK_HOUSING"] = "Block Housing / Decor"
L["LOOT_FILTER_BLOCK_HOUSING_DESC"] = "Player housing decorations (item class 20)."
L["LOOT_FILTER_BLOCK_MISC_REAGENT"] = "Block Misc: Crafting Reagents"
L["LOOT_FILTER_BLOCK_MISC_REAGENT_DESC"] = "Class 15 / subclass 1 — non-tradeskill crafting reagents."
L["LOOT_FILTER_BLOCK_MISC_OTHER"] = "Block Misc: Other (Anima)"
L["LOOT_FILTER_BLOCK_MISC_OTHER_DESC"] = "Class 15 / subclass 4 — Anima and similar curio items."
L["LOOT_FILTER_RESET_DEFAULTS"] = "Reset to Defaults"
L["LOOT_FILTER_RESET_DEFAULTS_DESC"] = "Restore the original blocklist (consumables, reagents, recipes, quest items, decor)."
L["LOOT_FILTER_RESET_CONFIRM"] = "Reset all class-block toggles to their default values?"
...
L["LOOT_PICKER_SELECT_ALL"] = "Select All"
L["LOOT_PICKER_SELECT_NONE"] = "Select None"
L["LOOT_PICKER_START_FMT"] = "Start Session  -  %d items"
L["LOOT_PICKER_CANCEL"] = "Cancel"
L["LOOT_PICKER_EMPTY"] = "No tradable loot detected."
L["LOOT_PICKER_WAITING_FMT"] = "Waiting for roll results… (%ds remaining)"
L["LOOT_PICKER_ALL_BLOCKED_FMT"] = "%d items hidden - toggle Show blocked to review."
L["LOOT_PICKER_AUTOCOMMIT_FAILED_FMT"] = "Loot Picker preserved prior selections; could not auto-start before new encounter: %s"
L["LOOT_PICKER_PREVIOUS_OPEN_WARNING"] = "Loot Picker is still open for a previous encounter; resolve it before starting another picker."
L["LOOT_PICKER_LOOTER_FMT"] = "Looter: %s"
L["LOOT_PICKER_UNKNOWN_LOOTER"] = "Unknown"
L["LOOT_PICKER_ILVL_FMT"] = "ilvl %d"
L["LOOT_PICKER_BLOCKED_REASON_FMT"] = "Blocked by filter: %s"
L["LOOT_PICKER_BLOCKED_QUALITY_FMT"] = "Below quality threshold (q%d < q%d)"
L["LOOT_PICKER_REASON_IGNORED"] = "ignored item"
L["LOOT_PICKER_REASON_BOE"] = "Bind on Equip"
L["LOOT_PICKER_REASON_UNKNOWN"] = "unknown"
L["LOOT_PICKER_CHIP_BLOCKED"] = "BLOCKED"
L["LOOT_PICKER_START_FAILED"] = "Could not start the loot session — your picks were preserved."
...
L["TRIGGER_TIMING_AFTER_LOOT"] = "After encounter loot"
...
L["COLUMN_WK"] = "Wk"
L["COLUMN_VOTE"] = "Vote"
L["COLUMN_TOOLTIP_WISHLIST"] = "Wishlist priority from loothing.xyz"
...
L["POPUP_CONFIRM_REVOTE_COMPLETED_FMT"] = "This item has already been %s. Clear the result and restart voting for %s?"
...
L["SESSION_SETTINGS_LOCKED"] = "Settings are locked while a session is active. The Master Looter (%s) controls these settings."
L["SESSION_SETTINGS_LOCKED_SHORT"] = "Settings are locked during an active session."
...
L["HANDLE_LOOT_TOGGLE"] = "Handle Loot"
L["HANDLE_LOOT_TOGGLE_DESC"] = "When enabled, Loothing takes over all loot. Raid members auto-pass rolls so the Master Looter collects items for distribution."
L["HANDLE_LOOT_HINT_ENABLE"] = "Enable this before starting a session so raid members auto-pass items to you."
L["HANDLE_LOOT_DISABLED"] = "Loot handling disabled. Blizzard will handle loot rolls."
L["START_SESSION_DESC"] = "Begin a loot distribution session. Items added to the session will be put to a council vote."
L["END_SESSION_DESC"] = "End the current session. All pending items will be closed and results finalized."
...
L["VOTE_CLOSED_FOR_ITEM"] = "Voting has closed for this item."
L["VOTE_POLL_WAITING"] = "The Master Looter is waiting for your council vote!"
L["SELECT_CANDIDATE"] = "Select Candidate"
...
-- Desktop Intel Share
L["INTEL_SHARE"] = "Desktop Intel"
L["INTEL_SHARE_STARTED"] = "Sharing desktop intel to %s..."
L["INTEL_SHARE_PROGRESS"] = "Sharing: %s (%d/%d)..."
L["INTEL_SHARE_COMPLETE"] = "Desktop intel shared (%d datasets)."
L["INTEL_SHARE_COOLDOWN"] = "Please wait %ds before sharing again."
L["INTEL_SHARE_NO_DATA"] = "No desktop data available. Run the Loothing desktop app first."
L["INTEL_SHARE_BUSY"] = "A share is already in progress."
L["INTEL_SHARE_NOT_IN_GROUP"] = "You must be in a group to share to group."
L["INTEL_SHARE_NOT_IN_GUILD"] = "You must be in a guild to share to guild."
L["INTEL_RECEIVE_STARTED"] = "Receiving desktop intel from %s..."
L["INTEL_RECEIVE_PROGRESS"] = "Receiving desktop intel from %s (%d/%d)..."
L["INTEL_RECEIVE_COMPLETE"] = "Received desktop intel from %s (%d/%d datasets merged)."
L["INTEL_RECEIVE_TIMEOUT"] = "Intel transfer from %s timed out (%d/%d received)."
L["INTEL_PURGE_DONE"] = "Purged shared intel. Your own desktop data is unchanged."
L["INTEL_PURGE_NOTHING"] = "No shared intel to purge."
L["INTEL_SHARE_STATUS_HEADER"] = "Desktop intel status:"
L["INTEL_SHARE_STATUS_LINE"] = "  %s: %s (%s)"
L["INTEL_SHARE_STATUS_NONE"] = "  No desktop data available."
L["INTEL_SHARE_STATUS_SHARED"] = "shared by %s"
L["INTEL_SHARE_STATUS_DESKTOP"] = "from desktop app"
L["INTEL_SHARE_DATASETS_READY"] = "%d datasets ready to share"
L["INTEL_RECEIVE_DECLINED"] = "Declined desktop intel from %s."
L["INTEL_AUTO_DECLINED"] = "Auto-declined a data share from %s (declined recently — cooldown expires in %d min)."
L["POPUP_INTEL_SHARE_TITLE"] = "Desktop Intel Share"
L["POPUP_INTEL_SHARE_REQUEST"] = "A player wants to share desktop intel with you."
L["POPUP_INTEL_SHARE_FMT"] = "%s wants to share desktop intel (%d datasets). This will write data to your saved variables. Accept?"
L["POPUP_INTEL_SHARE_RELOAD"] = "Desktop intel received. Reload your UI for the new data to take full effect."
L["POPUP_INTEL_SHARE_RELOAD_FMT"] = "Received desktop intel from %s (%d/%d datasets merged). Reload your UI for the new data to take full effect."
L["RELOAD_UI"] = "Reload UI"
L["LATER"] = "Later"
L["SLASH_DESC_SHARE"] = "Share or manage desktop intel"
